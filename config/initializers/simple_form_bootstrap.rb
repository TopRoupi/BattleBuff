...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: "div", class: "mb-6" do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: "block mb-2 text-sm text-gray-400"
    b.use :input, class: "w-full px-3 py-2 rounded-md focus:outline-none focus:ring bg-gray-700 text-white placeholder-gray-500 border-gray-600 focus:ring-gray-600 focus:border-gray-500", error_class: "border-red-500", valid_class: "border-green-500"
